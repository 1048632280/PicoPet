...
| --- | --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| 2026-07-01 | v0.4.0 behavior expression release executable `src-tauri/target/release/picopet.exe` from RC prep working tree | Microsoft Windows 10 家庭中文版 10.0.19045 | 149.0.4022.98 | 33.3 | 12.1 | 8.1 | 319.2 | 173.4 | 83.7 | 91.8 | 352.5 | 185.5 | 7 | Measured after 70 seconds idle from the release executable built by `pnpm release:windows:gate` during v0.4.0 RC prep. Host + WebView2 Private Working Set is within the 50-100 MB release target. Total Working Set is diagnostic only. No launch-shell child was present. Raw process tree saved to ignored `docs/qa/memory-baseline.latest.json`. Cleanup: RemainingPicoPet=0. |
| 2026-06-26 | v0.2.1 behavior configuration release executable `src-tauri/target/release/picopet.exe` from version-prep working tree | Windows 10 Home China 10.0.19045 | 149.0.4022.80 | 33.6 | 12.0 | 8.0 | 323.7 | 181.1 | 88.1 | 96.1 | 357.3 | 193.1 | 7 | Measured after 70 seconds idle from the release executable built by `pnpm release:windows:gate` during v0.2.1 release prep. Host + WebView2 Private Working Set is within the 50-100 MB release target. Total Working Set is diagnostic only. No launch-shell child was present. Raw process tree saved to ignored `docs/qa/memory-baseline.latest.json`. Cleanup: RemainingPicoPet=0. |
