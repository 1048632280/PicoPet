...
- Release installer exists at `src-tauri/target/release/bundle/nsis/PicoPet_<package version>_x64-setup.exe`.
- Install into a user-writable directory for Beta portable-data testing.

## Clean Install

- [ ] Run the current generated `PicoPet_<package version>_x64-setup.exe` installer.
